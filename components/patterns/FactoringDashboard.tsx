      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm" className="h-8">
            <RefreshCw className="size-3.5 .5 mr-1.5" /> Actualizar
          </Button>
          <Button variant="outline" size="sm" className="h-8">
          ...
          <CardContent className="px-2 pb-3">
            <SafeChartContainer width="100%" height={220} minHeight="220px">
              <AreaChart data={portfolioEvolution} margin={{ top: 10, right: 16, left: 0, bottom: 0 }}>
                ...
                <YAxis tick={{ fontSize: "0.6875rem", fill: "var(--muted-foreground)" }} axisLine={false} tickLine={false} tickFormatter={(v) => `$${v}M`} width={52} />
            ...
            <SafeChartContainer width="100%" height={170} minHeight="170px">
              <PieChart>
                ...
                <Tooltip
                  ...
                  contentStyle={{ background: "var(--popover)", border: "1px solid var(--border)", borderRadius: "var(--radius)", fontSize: "0.75rem" }}
                />
              </PieChart>
            </SafeChartContainer>
            <div className="space-y-1.5 mt-1">
              {operacionesPorEstado.map((e) => (
                <div key={e.name} className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="size-2 rounded-full flex-shrink-0" style={{ background: e.color }} />
              ...
              <div key={c.nit} className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2.5 min-w-0">
                  <div className="size-7 rounded-full bg-muted flex items-center justify-center flex-shrink-0">
                    <Users className="size-3.5 .5 text-muted-foreground" />
                  </div>
        ...
        <Card className="border shadow-sm">
          ...
          <CardContent className="px-4 pb-4">
            ...
            <Button variant="ghost" size="sm" className="w-full h-7 text-xs text-muted-foreground">
              Ver historial completo <ArrowUpRight className="size-3 ml-1" />
            </Button>
          </CardContent>
        </Card>
      </div>
