...
const impactIcon = {
  positive: <CheckCircle2 className="h-3.5 w-3.5 text-success flex-shrink-0" />,
  negative: <AlertTriangle className="h-3.5 w-3.5 text-destructive flex-shrink-0" />,
  neutral:  <Info className="h-3.5 w-3.5 text-muted-foreground flex-shrink-0" />,
};
