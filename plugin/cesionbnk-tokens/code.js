...
// Fuente: tokens/cesionbnk.tokens.json v7.0.0 (2026-03-16)
...
(async () => {
  ...
  sem('Surface/Foreground', '#222222', '#fafafa');
  sem('Surface/Card', '#ffffff', '#09090b');
  sem('Surface/Card Foreground', '#222222', '#fafafa');
  sem('Surface/Popover', '#ffffff', '#18181b');
  sem('Surface/Popover Foreground', '#222222', '#fafafa');
