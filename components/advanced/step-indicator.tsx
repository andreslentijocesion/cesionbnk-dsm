                  ...
                  >
                    {step.icon ? (
                      isCompleted ? <CheckCircle className="h-4 w-4 md:h-5 md:w-5" /> : (
                        <div className="flex items-center justify-center [&>svg]:h-4 [&>svg]:w-4 md:[&>svg]:h-5 md:[&>svg]:w-5">{step.icon}</div>
                      )
        ...
        return (
          <div key={step.id} className="flex items-start gap-4">
            <div className="flex flex-col items-center">
              ...
              >
                {step.icon ? (isCompleted ? <CheckCircle className="h-5 w-5" /> : step.icon) : <span className="font-semibold">{index + 1}</span>}
              </button>
              {index < steps.length - 1 && (
