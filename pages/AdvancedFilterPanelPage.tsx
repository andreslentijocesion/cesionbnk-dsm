...
const advancedFilterCode = `import { AdvancedFilterPanel } from "@/components/patterns/advanced-filter-panel"
      ...
      examples={[
        {
          ...
          code: `import { AdvancedFilterPanel } from "@/components/patterns/advanced-filter-panel"
