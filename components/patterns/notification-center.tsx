        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0 space-y-1">
            <div className="flex items-start justify-between gap-2">
              ...
              {!notification.read && (
                <Badge variant="outline" className="size-2 p-0 rounded-full" />
              )}
            </div>
              ...
              <div className="space-y-3">
                {notificationList.length === 0 ? (
                  <div className="text-center py-8 text-muted-foreground">
                    <Bell className="size-12 mx-auto mb-2 opacity-20" />
            ...
            <TabsContent value="unread" className="m-0 p-4">
              <div className="space-y-3">
                {unreadNotifications.length === 0 ? (
                  <div className="text-center py-8 text-muted-foreground">
                    <CheckCircle className="size-12 mx-auto mb-2 opacity-20" />
            ...
            <TabsContent value="read" className="m-0 p-4">
              <div className="space-y-3">
                {readNotifications.length === 0 ? (
                  <div className="text-center py-8 text-muted-foreground">
                    <Info className="size-12 mx-auto mb-2 opacity-20" />
