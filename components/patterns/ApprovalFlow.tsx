          ...
          return (
            <li key={approver.id} className="flex gap-3">
              <div className="flex flex-col items-center">
                <div className={cn("flex size-8 flex-shrink-0 items-center justify-center rounded-full border-2 transition-colors", meta.dotClass)}>
              ...
              <div className={cn("pb-4 flex-1 min-w-0", isLast && "pb-0")}>
                ...
                {approver.comment && (
                  <div className="mt-1.5 flex gap-1.5 items-start text-xs text-muted-foreground bg-muted/40 rounded-md px-2.5 py-2">
                    <MessageSquare className="size-3.5 .5 flex-shrink-0 mt-0.5" />
