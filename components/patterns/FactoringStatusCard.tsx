  ...
  return (
    <button
      ...
      style={{
        ...
        ...(active && {
          backgroundImage: `linear-gradient(var(--card), var(--card)), linear-gradient(to right, ${color}, color-mix(in srgb, ${color} 25%, black))`,
    ...
    >
      ...
      <div className="flex items-end justify-between gap-2">
        ...
        {/* Status icon */}
        <Icon
          className={cn("shrink-0 size-8", active ? "" : "text-muted-foreground")}
          style={{
